...
(function () {
    ...
    openerp.website.RTE = openerp.website.RTE.extend({
        _config: function () {
            ...
            config.colorButton_colors = 'ffffff,555555,000000,fcde80,e50046,50646a,fde180,9dd1ec,84bd32,e8e8e8';
            ...
            config.stylesSet = [
                ...
                {name: 'p Klein', element: 'p', attributes: { 'class': 'pfot_small' } },
                {name: 'p Winzig', element: 'p', attributes: { 'class': 'pfot_tiny' } },
                {name: 'H1', element: 'h1'},
                {name: 'H2', element: 'h2'},
                {name: 'H3', element: 'h3'},
                {name: 'H4', element: 'h4'},
